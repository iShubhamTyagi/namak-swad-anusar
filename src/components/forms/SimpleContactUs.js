...
const FormContainer = styled.div`
  ${tw`p-10 sm:p-12 md:p-16 bg-primary-200 text-gray-100 rounded-lg relative shadow-2xl`}
  form {
    ${tw`mt-4`}
  }
  h2 {
...
const Label = tw.label`font-sans absolute top-0 left-0 tracking-wide font-semibold text-sm`;
const Input = tw.input`font-sans `;
const TextArea = tw.textarea`h-24 sm:h-full resize-none`;
const SubmitButton = tw.button`font-sans w-full sm:w-32 mt-6 py-3 bg-gray-100 text-primary-500 rounded-full font-bold tracking-wide shadow-lg uppercase text-sm transition duration-300 transform focus:outline-none focus:shadow-outline hover:bg-gray-300 hover:text-primary-700 hocus:-translate-y-px hocus:shadow-xl`;
                ...
                <Column>
                  <InputContainer tw="flex-1">
                    ...
                    <TextArea
                      id="message-input"
                      name="message"
                      placeholder="E.g. Hi! I love your website! do you mind..."
                    />
                  </InputContainer>
                </Column>
              </TwoColumn>
